...
class ResNetm(nn.Module):
    ...
    def __init__(self,in_channel,out_channel):
        ...
        self.in_planes =32 #define the inital dimension of channel
        block = BottleBlock
        layer = [3,4,6,3]
        ...
        self.layer1 = self._make_layer(block,32,layer[0])
        self.layer2 = self._make_layer(block,64,layer[1],stride=2)
        self.layer3 = self._make_layer(block,128,layer[2],stride=2)
        self.layer4 = self._make_layer(block,256,layer[3],stride=2)
        ...
        self.Up1 = up_conv(ch_in=32, ch_out=32)
        
        self.Conv_1x1 = nn.Conv2d(32,out_channel,kernel_size=1)
